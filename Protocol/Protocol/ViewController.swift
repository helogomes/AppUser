...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let pessoa1 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image1", customID: 1)
        let pessoa2 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image2", customID: 2)
        let pessoa3 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image3", customID: 3)
        let pessoa4 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image4", customID: 4)
        let pessoa5 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image5", customID: 5)
        let pessoa6 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image1", customID: 6)
        let pessoa7 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image2", customID: 7)
        let pessoa8 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image3", customID: 8)
        let pessoa9 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image4", customID: 9)
        let pessoa10 = Pessoa(name: "Heloisa", lastName: "Gomes", age: 21, gender: .feminine, avatar: "image5", customID: 10)
...
extension ViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "EditViewController"{
            ...
            vc?.pessoaSelecioanda = sender as? Pessoa
        }
